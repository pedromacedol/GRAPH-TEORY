...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_p_dfs_z.adicionaAresta('a8', 'M', 'T')
        ...
        #Grafos Eulerianos:
        self.g_e_impares = MeuGrafo(['A','B','C','D', 'E'])
        self.g_e_impares.adicionaAresta('a1', 'A', 'B')
        self.g_e_impares.adicionaAresta('a2', 'B', 'D')
        self.g_e_impares.adicionaAresta('a3', 'C', 'A')
        self.g_e_impares.adicionaAresta('a4', 'B', 'C')
        self.g_e_impares.adicionaAresta('a5', 'E', 'D')
        self.g_e_impares.adicionaAresta('a6', 'A', 'E')

        self.g_e_impares_2 = MeuGrafo(['A','B','C','D'])
        self.g_e_impares_2.adicionaAresta('a1','A','D')
        self.g_e_impares_2.adicionaAresta('a2', 'D', 'B')
        self.g_e_impares_2.adicionaAresta('a3', 'B', 'C')
        self.g_e_impares_2.adicionaAresta('a4', 'C', 'D')

        self.g_e_par = MeuGrafo(['A','B','C','D'])
        self.g_e_par.adicionaAresta('a1','A','B')
        self.g_e_par.adicionaAresta('a2', 'B', 'C')
        self.g_e_par.adicionaAresta('a3', 'C', 'D')
        self.g_e_par.adicionaAresta('a4', 'D', 'A')
  

        self.g_e_par_2 = MeuGrafo(['A','B','C','D','E'])
        self.g_e_par_2.adicionaAresta('a1','A','D')
        self.g_e_par_2.adicionaAresta('a2', 'E', 'C')
        self.g_e_par_2.adicionaAresta('a3', 'E', 'D')
        self.g_e_par_2.adicionaAresta('a4', 'A', 'E')
        self.g_e_par_2.adicionaAresta('a5', 'B', 'E')
        self.g_e_par_2.adicionaAresta('a6', 'C', 'B')
        
        self.g_e_impares_3 = MeuGrafo(['J', 'E'])
        self.g_e_impares_3.adicionaAresta('a1', 'J', 'E')
    ...
    def test_dfs(self):
        ...
        self.assertEqual(self.g_c2.dfs('Nina'), self.g_a_dfs_nina)
        self.assertEqual(self.g_p.dfs('Z'), self.g_p_dfs_z)
    
    def test_bfs(self):
        self.assertEqual(self.g_p_sem_paralelas.bfs('E'), self.g_p_sem_paralelas_bfs_e)
        self.assertEqual(self.g_p.bfs('C'), self.g_p_bfs_c)
        self.assertEqual(self.g_p.bfs('J'), self.g_p_paralelas_bfs_j)
        self.assertEqual(self.g_c2.bfs('Nina'), self.g_c2_bfs_nina)
        
    def test_ha_ciclo(self):
        self.assertFalse(self.g_ac.ha_ciclo())
        self.assertEqual(self.g_cn4.ha_ciclo(), ['2', 'a1', '1', 'a4', '5', 'a11', '2'])
        self.assertFalse(self.g_ac2.ha_ciclo())
        self.assertEqual(self.g_p.ha_ciclo(), ['C', 'a2', 'E', 'a3', 'C'])
        self.assertEqual(self.g_cn3.ha_ciclo(),  ['1', 'a1', '2', 'a2', '1'])
        self.assertFalse(self.g_d.ha_ciclo())
        self.assertEqual(self.g_p_sem_paralelas.ha_ciclo(),['C', 'a4', 'T', 'a6', 'M', 'a5', 'C'])
        self.assertFalse(self.g_l5.ha_ciclo())
        self.assertEqual(self.g_cn2.ha_ciclo(),['7', 'a6', '5', 'a7', '7'])
    
    def test_caminho(self):
        self.assertFalse(self.g_p.caminho(9))
        self.assertEqual(self.g_p.caminho(2), ['J', 'a1', 'C', 'a6', 'T'])
        self.assertEqual(self.g_cm.caminho(3), ['J', 'a1', 'E', 'a5', 'C', 'a2', 'J'])
        self.assertFalse(self.g_cm.caminho(4))
    
    def test_conexo(self):
        self.assertTrue(self.g_cn.conexo())
        self.assertFalse(self.g_d.conexo())
        self.assertTrue(self.g_cn2.conexo())
        self.assertFalse(self.g_d2.conexo())
        self.assertTrue(self.g_cn3.conexo())
        self.assertTrue(self.g_cn4.conexo())
    ...
    def test_caminho_euleriano(self):
        ...
        self.assertEqual(self.g_e_impares.caminho_euleriano(), ['A', 'a3', 'C', 'a4', 'B', 'a1', 'A', 'a6', 'E', 'a5', 'D', 'a2', 'B'])
        self.assertFalse(self.g_cn2.caminho_euleriano())
        self.assertEqual(self.g_e_impares_2.caminho_euleriano(), ['A', 'a1', 'D', 'a2', 'B', 'a3', 'C', 'a4', 'D'])
        self.assertEqual(self.g_e_par_2.caminho_euleriano(), ['A', 'a1', 'D', 'a3', 'E', 'a2', 'C', 'a6', 'B', 'a5', 'E', 'a4', 'A'])
        self.assertFalse(self.g_d.caminho_euleriano())
        self.assertFalse(self.g_d2.caminho_euleriano())
        self.assertEqual(self.g_e_par.caminho_euleriano(), ['A', 'a1', 'B', 'a2', 'C', 'a3', 'D', 'a4', 'A'])
        self.assertEqual(self.g_cm.caminho_euleriano(), ['J', 'a1', 'E', 'a3', 'P', 'a4', 'E', 'a5', 'C', 'a2', 'J'])
        self.assertEqual(self.g_e_impares_3.caminho_euleriano(), ['J', 'a1', 'E'])